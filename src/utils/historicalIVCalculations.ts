...
const generateDates = (timeFrame: number): string[] => {
  const dates: string[] = [];
...
const calculateImpliedVolTimeSeries = (
  dates: string[], 
  spotPrice: number, 
  riskFreeRate: number
): VolatilityPoint[] => {
...
const calculateHistoricalVolTimeSeries = (
  dates: string[], 
  spotPrice: number
): VolatilityPoint[] => {
  return dates.map(date => {
...
const calculateMetrics = (
  impliedVolatility: VolatilityPoint[], 
  historicalVolatility: VolatilityPoint[]
): VolatilityMetrics => {
